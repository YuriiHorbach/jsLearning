...
// console.log(btnPlus);
let tdProd = document.querySelectorAll('.prod');
console.log(tdProd);
let btnsPlus = document.querySelectorAll('.btnPlus');

for(let i = 0; i < tdProd.length; i++){
    tdProd[i].onclick = function(){
        // console.log(tdProd[i]);
    }
    
}

let quantityProduct = document.querySelectorAll('.quant');
